...
public class ImageMileage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
	    ...
	    MileageLongitude = ("" + AbstractArchitectCamActivity.longitude).substring(0, 5);
	    MileageLatitude = ("" + AbstractArchitectCamActivity.latitude).substring(0, 4);
	    ...
	    longX = AbstractArchitectCamActivity.longitude;
	    latX = AbstractArchitectCamActivity.latitude;
	    ...
	    else
	    {
	    	...
	    	txt_1.setText("距離約：" + nf.format(s / 1000) + "km處," + DataArray[4] + "," + DataArray[2] + "km/hr");
	    }
	    /***************************************************************************************************/
	    ...
	    else
	    {
	    	...
	    	txt_2.setText("距離約：" + nf.format(s / 1000) + "km處," + DataArray[10] + "," + DataArray[8] + "km/hr");
	    }    
	    /***************************************************************************************************/
	    ...
	    else
	    {
	    	...
	    	txt_3.setText("距離約：" + nf.format(s / 1000) + "km處," + DataArray[16] + "," + DataArray[14] + "km/hr");
	    }
    ...
    {
    	MileageData = getHtmlByGet(imageDataURL + "?longitude=" + MileageLongitude + "&latitude=" + MileageLatitude);
