...
var ServerInformation = {
	POIDATA_SERVER: "http://140.126.11.39/1/poi.json",
...
var World = {
	...
	*/
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		var serverUrl = ServerInformation.POIDATA_SERVER + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&" + ServerInformation.POIDATA_SERVER_ARG_NR_POIS + "=3";
